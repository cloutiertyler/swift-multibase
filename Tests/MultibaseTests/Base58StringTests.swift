...
class Base58StringTests: XCTestCase {
    func testEncodeBase58Strings() {
        for (decoded, encoded) in testStrings {
            ...
            let result = Data(bytes).base58EncodedString()
    ...
    func testDecodeBase58Strings() {
        for (decoded, encoded) in testStrings {
            ...
            let bytes = Data(base58Encoded: encoded)!
    ...
    func testDecodeInvalidBase58Strings() {
        for (encoded, _) in invalidTestStrings {
            ...
            let result = Data(base58Encoded: encoded)
    ...
    func testPerformanceDecodeShort() {
        ...
        self.measure() {
            ...
            let _ = Data(base58Encoded: encoded)
        }
    }
    ...
    func testPerformanceEncodeShort() {
        ...
        self.measure() {
            // Put the code you want to measure the time of here.
            let _ = bytes.base58EncodedString()
        }
    }
